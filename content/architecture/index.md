...
Lost Last состоит из трех частей: бэкенд, фронтенд и TG bot. Бэкенд и фронтенд
образуют CTF-платформу, а TG bot добавлен как отдельная заглушка сервиса поддержки
для выполнения ТЗ.
...
| TG bot | Telegram-заглушка сервиса поддержки |
...
операторов поддержки. В архитектуре проекта он считается отдельной заглушкой
под требования ТЗ.
